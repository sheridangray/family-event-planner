// Live test of Bay Area Kid Fun scraper to see actual events found
const BayAreaKidFunScraper = require('./src/scrapers/bayareakidfun');
...
async function testLiveScraping() {
  console.log('🚀 Testing Bay Area Kid Fun scraper with live data...\n');
  
  try {
    const scraper = new BayAreaKidFunScraper(mockLogger);
    console.log(`Scraper: ${scraper.name}`);
    console.log(`Main URL: ${scraper.url}`);
    console.log(`Weekend URL: ${scraper.weekendHighlightsUrl}\n`);
